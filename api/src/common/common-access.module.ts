...
import { WorkflowNode, WorkflowNodeSchema } from '../nodes/schemas/node.schema';
...
/**
 * Workflow/Node/Project 모델과 WorkflowAccessGuard를 한 곳에서 등록해 공유한다 — 이들을
 * 쓰는 모듈(workflows, nodes, artifacts, releases, edges, memos, canvas)이 각자 다시
