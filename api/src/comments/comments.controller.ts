 ...
 *   설계서 01장 §3.8 확장) — artifact 자체의 view/edit 권한이나 node.recipients 소속과
 ...
 */
@Controller('workflows/:workflowId/nodes/:nodeId/comments')
...
export class CommentsController {
  ...
  @Get()
  @WorkflowAccess('edit')
  async list(@Param('nodeId') nodeId: string) {
    return { data: await this.comments.listForNode(nodeId) };
  }
  ...
  async create(
    ...
    return this.comments.createForNode(nodeId, dto, me);
  }
}
