  ...
  return (
    <Box
      ...
      sx={{
        ...
        borderRadius: '15px',
        padding: '15px 16px',
        background: `repeating-linear-gradient(135deg,${T.memo} 0 13px,${T.memoLine} 13px 26px)`,
        border: `1.5px dashed ${isSel ? T.pr : T.ln3}`,
        boxShadow: isSel ? `0 0 0 4px ${T.prSoft}, ${T.shSm}` : T.shSm,
        color: T.dm,
        fontSize: 18,
        lineHeight: 1.5,
