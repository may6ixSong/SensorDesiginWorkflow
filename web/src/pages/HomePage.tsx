...
const PALETTE: Record<'light' | 'dark', Palette> = {
  ...
  light: {
    stageBg: '#fbfbfa',
    aurora:
      'radial-gradient(50% 42% at 22% 18%, rgba(99,102,241,.05), transparent 72%),' +
      'radial-gradient(46% 40% at 80% 78%, rgba(13,148,136,.05), transparent 74%)',
    gridLine:
    ...
    laneBorder: 'rgba(16,24,40,.06)',
    laneBg: 'rgba(16,24,40,.014)',
    laneText: 'rgba(16,24,40,.32)',
    cardBg: '#ffffff',
    cardBorder: 'rgba(16,24,40,.08)',
    cardShadow: '0 1px 2px rgba(16,24,40,.04), 0 8px 20px -4px rgba(16,24,40,.08)',
    cardText: '#101828',
    cardSub: '#667085',
    wordmarkGradient: 'linear-gradient(180deg,#101828 0%,#3a4658 100%)',
    wordmarkGlow: 'none',
    subCopy: '#98a2b3',
    flowStroke: 'rgba(16,24,40,.10)',
    pulse: 'rgba(13,148,136,.55)',
    ctaBg: '#101828',
    ctaText: '#ffffff',
    ctaShadow: '0 1px 2px rgba(16,24,40,.06), 0 4px 10px rgba(16,24,40,.12)',
    ctaShadowHover: '0 4px 8px rgba(16,24,40,.1), 0 8px 20px rgba(16,24,40,.18)',
    circuitLine: 'rgba(16,24,40,.055)',
    circuitNode: 'rgba(16,24,40,.12)',
    circuitActive: 'rgba(13,148,136,.22)',
    connLive: 'rgba(13,148,136,.4)',
    connPending: 'rgba(16,24,40,.07)',
    badgeLiveBg: 'transparent',
    badgeLiveText: '#0d9488',
    badgePendingText: '#98a2b3',
  },
} as const;
